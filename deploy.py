#!/usr/bin/env python3
"""
Simple deployment script for Clinic AI Assistant
"""
...
def find_available_port(start_port=12000, max_attempts=10):
...
if __name__ == '__main__':
    ...
    # Find available port
    preferred_ports = [12000, 12001, 8000, 5000]
    port = None
    ...
    print(f"Starting Clinic AI Assistant on port {port}")
    print(f"Access the application at: http://localhost:{port}")
    
    if port in [12000, 12001]:
        public_urls = {
            12000: "https://work-1-iltjhikhqonchwsy.prod-runtime.all-hands.dev",
            12001: "https://work-2-iltjhikhqonchwsy.prod-runtime.all-hands.dev"
        }
        if port in public_urls:
            print(f"🌐 PUBLIC URL: {public_urls[port]}")
